...
const LoginButton = ({ onClick, href, children }) => (
  <button
    onClick={onClick}
    className="px-5 py-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-lg shadow-md hover:shadow-lg transition-all text-sm font-medium"
  >
    {children}
  </button>
);
...
export default function Home() {
  ...
  const calculateMinHeight = () => {
    if (selectedFiles.length === 0) return '200px';
  ...
  return (
    <main className="flex w-full h-screen flex-col items-center bg-gradient-to-br from-blue-50 via-white to-purple-50 overflow-hidden">
      ...
      <div className="flex-1 w-full px-2 py-3 overflow-y-auto">
        <div className="max-w-4xl mx-auto">

        <div className="flex flex-col gap-3 mb-4">
          {/* 标题和基本信息 */}
          <div className="flex flex-col bg-white rounded-xl p-4 shadow-md">
            <div className="text-gray-800 text-xl font-bold mb-2">文件上传</div>
          ...
          {/* 接口选择和WebP转换 */}
          <div className="flex flex-wrap items-center gap-3 bg-white rounded-xl p-4 shadow-md">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="px-3 py-2 border border-gray-300 rounded-lg bg-white text-sm w-24 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
            </div>
        ...
        >
          <div className="flex flex-wrap gap-3 min-h-[200px] p-4">
        ...
        <div className="w-full mt-4 mb-2">
          {uploadedImages.length > 0 && (
            <>
              <div className="mb-4 bg-white rounded-xl p-4 shadow-md flex justify-between items-center">
                <div>
                  <h3 className="text-lg font-bold text-gray-800 mb-1">已上传的文件</h3>
                  <p className="text-sm text-gray-500">点击链接即可复制</p>
                </div>
                <button
                  onClick={handleCopyAll}
                  className="px-4 py-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-lg shadow-md hover:shadow-lg transition-all text-sm font-medium"
                >
      ...
      <footer className="w-full h-[55px] bg-white/80 backdrop-blur-md border-t border-gray-200 flex justify-center items-center shadow-sm flex-shrink-0">
        <Footer />
      </footer>
    </main>
  );
