...
export default function Home() {
  ...
  const calculateMinHeight = () => {
    if (selectedFiles.length === 0) {
      return typeof window !== 'undefined' && window.innerWidth >= 768 ? '200px' : '120px';
    }
    const rows = Math.ceil(selectedFiles.length / 4);
    const baseHeight = typeof window !== 'undefined' && window.innerWidth >= 768 ? 110 : 100;
    return `${rows * baseHeight}px`;
  };
  ...
  return (
    <main className="flex w-full h-screen flex-col items-center bg-gradient-to-br from-blue-50 via-white to-purple-50 overflow-hidden">
      <header className="w-full h-[45px] md:h-[60px] border-b bg-white/80 backdrop-blur-md flex z-50 justify-between items-center shadow-sm px-3 md:px-4 flex-shrink-0">
        <span className="text-base md:text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">北方的博客</span>
        {renderButton()}
      </header>
      <div className="flex-1 w-full px-2 py-1.5 md:py-3 overflow-y-auto">
        <div className="max-w-4xl mx-auto">

        <div className="flex flex-col gap-2 md:gap-3 mb-2 md:mb-4">
          {/* 标题和基本信息 */}
          <div className="flex flex-col bg-white rounded-lg md:rounded-xl p-2.5 md:p-4 shadow-sm md:shadow-md">
            <div className="text-gray-800 text-base md:text-xl font-bold mb-1 md:mb-2">文件上传</div>
          ...
          {/* 接口选择和WebP转换 */}
          <div className="flex flex-wrap items-center gap-2 md:gap-3 bg-white rounded-lg md:rounded-xl p-2.5 md:p-4 shadow-sm md:shadow-md">
            <div className="flex items-center gap-1.5 md:gap-2">
              <span className="text-xs md:text-sm text-gray-700 font-medium">接口:</span>
              <select
                value={selectedOption}
                onChange={handleSelectChange}
                className="px-2 md:px-3 py-1 md:py-2 border border-gray-300 rounded-md md:rounded-lg bg-white text-xs md:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              >
            ...
            <div className="flex items-center gap-1.5 md:gap-2">
              <span className="text-xs md:text-sm text-gray-700 font-medium">密码:</span>
              <input
                type="text"
                maxLength="6"
                placeholder="6位"
                ...
                className="px-2 md:px-3 py-1 md:py-2 border border-gray-300 rounded-md md:rounded-lg bg-white text-xs md:text-sm w-16 md:w-24 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
            </div>
            ...
            <label className="flex items-center cursor-pointer group">
              <input
                ...
                className="w-3.5 h-3.5 md:w-4 md:h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2"
              />
              <span className="ml-1.5 md:ml-2 text-xs md:text-sm text-gray-700 group-hover:text-blue-600 transition-colors">转换WebP</span>
            </label>
          </div>
        </div>
        <div
        ...
        >
          <div className="flex flex-wrap gap-2 md:gap-3 min-h-[120px] md:min-h-[200px] p-2 md:p-4">
        ...
        <div className="w-full rounded-lg md:rounded-xl shadow-sm md:shadow-md overflow-hidden mt-2 md:mt-4 bg-white p-2 md:p-3">
          <div className="grid grid-cols-3 gap-1.5 md:gap-2">
            <div className="col-span-3 md:col-span-1">
              <div className="w-full h-8 md:h-10 bg-gray-50 rounded-md md:rounded-lg px-2 md:px-3 flex items-center justify-center border border-gray-200">
            ...
            <div className="col-span-1 md:col-span-1">
              <div
                className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 cursor-pointer h-8 md:h-10 flex items-center justify-center text-white rounded-md md:rounded-lg shadow-sm md:shadow-md hover:shadow-md md:hover:shadow-lg transition-all"
                onClick={handleClear}
              >
                <FontAwesomeIcon icon={faTrashAlt} style={{ width: '12px', height: '12px' }} className="mr-1 md:mr-2 md:w-4 md:h-4" />
                <span className="text-xs md:text-sm">清除</span>
              </div>
            </div>
            <div className="col-span-2 md:col-span-1">
              <div
                className={`w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 cursor-pointer h-8 md:h-10 flex items-center justify-center text-white rounded-md md:rounded-lg shadow-sm md:shadow-md hover:shadow-md md:hover:shadow-lg transition-all ${uploading ? 'pointer-events-none opacity-50' : ''}`}
                onClick={() => handleUpload()}
              >
                <FontAwesomeIcon icon={faUpload} style={{ width: '12px', height: '12px' }} className="mr-1 md:mr-2 md:w-4 md:h-4" />
        ...
        <ToastContainer />
        <div className="w-full mt-2 md:mt-4 mb-1 md:mb-2">
          {uploadedImages.length > 0 && (
            <>
              <div className="mb-2 md:mb-4 bg-white rounded-lg md:rounded-xl p-2 md:p-4 shadow-sm md:shadow-md flex justify-between items-center">
                <div>
                  <h3 className="text-sm md:text-lg font-bold text-gray-800 md:mb-1">已上传的文件</h3>
                  <p className="text-xs md:text-sm text-gray-500">点击链接复制</p>
                </div>
                <button
                  onClick={handleCopyAll}
                  className="px-2.5 md:px-4 py-1 md:py-2 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white rounded-md md:rounded-lg shadow-sm md:shadow-md hover:shadow-md md:hover:shadow-lg transition-all text-xs md:text-sm font-medium"
                >
      ...
      <footer className="w-full h-[40px] md:h-[55px] bg-white/80 backdrop-blur-md border-t border-gray-200 flex justify-center items-center shadow-sm flex-shrink-0">
        <Footer />
      </footer>
    </main>
  );
